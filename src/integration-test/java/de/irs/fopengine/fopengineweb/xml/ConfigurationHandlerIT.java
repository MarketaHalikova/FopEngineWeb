...
public class ConfigurationHandlerIT {
    ...
    public void updateProjectInXml_shouldSaveChanges() throws Exception {
        ...
        Project project = configurationHandler.createProject("gitUrl", Paths.get(PROJECT_DIRECTORY));
        ...
        Project updatedProject = configurationHandler.createProject("gitUrl", Paths.get(PROJECT_DIRECTORY));
    ...
    private void checkProjectValues(Project project, boolean checkChangeable) {
        ...
        assertThat(project.getGitUrl()).isEqualTo("gitUrl");

package de.irs.fopengine.fopengineweb.bootstrap;
...
import de.irs.fopengine.fopengineweb.repositories.UserRepository;
 ...
 * These are loaded on start of the application
 * with dev profile is used FakeFitRepository - id doesn't connect git
 * otherwise are loaded the test projects from git
 */
@Component
public class ProjectBootstrap implements ApplicationListener<ContextRefreshedEvent> {

    // repositories with test FopEngine projects
     ...
     * @param fontTripletRepository
     * @param projectService
     */
    public ProjectBootstrap(UserRepository userRepository, ProjectRepository projectRepository,
                            FontTripletRepository fontTripletRepository, ProjectService projectService) {
    ...
    public void onApplicationEvent(ContextRefreshedEvent contextRefreshedEvent) {
        ...
        // before git connection is implemented
